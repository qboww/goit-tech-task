...
const SVGSymbols = () => (
  ...
  >
    <defs>
      ...
      <symbol id="icon-heart-filled" width="18" height="16" viewBox="0 0 18 16">
        <path
      ...
      <symbol id="icon-arrow-down" width="12" height="8" viewBox="0 0 12 8">
        <path
